...
export default {
  ...
  methods: {
    ...
    onClickNode: function (node) {
      ...
      console.log("node[this.treeProps.label]", node[this.treeProps.label]);
      console.log("node[this.treeProps.value]", node[this.treeProps.value]);
      this.setLableValue(
        node[this.treeProps.label],
        node[this.treeProps.value]
      );
